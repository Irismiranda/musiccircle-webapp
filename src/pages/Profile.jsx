...
export default function Profile(){
    ...
    return(
        <div className="wrapper default_padding profile" style={{ width: standardWrapperWidth }}>
            {listVisibility.following && <List list={{items: formatListData({items: userProfileData.following}, "users")}} category={"userList"}/>}
            {listVisibility.followers && <List list={{items: formatListData({items: userProfileData.following_you}, "users")}} category={"userList"}/>}
